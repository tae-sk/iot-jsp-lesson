...
try {
	...
	Connection con = DriverManager.getConnection("jdbc:oracle:thin:@//localhost:1521/xe", "taeseok", "1234");
...
response.sendRedirect("../index.jsp?section=audition_player_list");
%>