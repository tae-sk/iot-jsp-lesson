...
SELECT * FROM SALE, PRODUCT WHERE SALE.PRODUCT_ID = PRODUCT.PRODUCT_ID;
SELECT category.name, sub(SALE.SALE_NAME) FROM SALE,PRODUCT,
category WHERE SALE.PRODUCT_ID = PRODUCT.PRODUCT_ID and 
category.CATEGORY_ID = PRODUCT.CATEGORY_ID group by category.CATEGORY_ID, category.name;
